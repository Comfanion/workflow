...
description: Gather and validate functional and non-functional requirements — elicit through interview questions, write them as atomic, measurable, testable, traceable statements, and check a finished requirements document for SMART quality, ambiguity, and conflicts. Use this whenever starting a new project or feature, collecting or refining requirements, reviewing/validating a requirements document, or when the user mentions "requirements", "FR", "NFR", "stakeholder needs", "user research", or "validate requirements". This document is the source of truth the PRD and everything downstream traces back to.
---
