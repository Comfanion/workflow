...
> **Maintained by:** 
> - the analysis role — Gathers requirements from stakeholders (fills ID, Requirement, Priority, Source)
> - the architecture role — Fills Module, Doc Section, Arch § after architecture design
> - the product role — Fills Epic after epic creation
> - the developer — Updates Status during implementation

> **Workflow:**
> 1. the analysis role creates requirements.md with FR/NFR (Module/Arch § empty)
> 2. the architecture role designs architecture.md, updates requirements.md (fills Module, Arch §)
> 3. the product role creates epics, updates requirements.md (fills Epic column)
> 4. the developer implements stories, updates requirements.md (Status: ⬜ → ✅)
