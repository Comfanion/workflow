---
name: prd-writing
description: Write, update, or validate a Product Requirements Document (PRD) — classify project size, define success metrics, scope (MVP/Growth/Out-of-scope), critical business rules, and a requirements summary; and check a finished PRD for completeness and requirements coverage. Use this whenever the user wants to spec a product or feature at the product level, document product vision, define what something delivers and why, review/validate an existing PRD, or mentions "PRD", "product requirements", "product spec", "feature definition", or "validate the PRD". The PRD captures WHY and WHAT only — keep the task breakdown, architecture, and detailed requirements out of it (they live in other documents).
---
