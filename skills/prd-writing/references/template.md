...
> See the classification table in SKILL.md for the size -> depth -> epic-granularity mapping.
...
→ **Requirements Document:** `{DOCS_ROOT}/requirements/requirements.md`
...
| Version | Date | Author | Changes |
|---------|------|--------|---------|
| 1.0 | 2026-01-15 | the product role | Initial PRD created from requirements |
| 1.1 | 2026-01-20 | the product role | Added AI-specific considerations |
| 1.2 | 2026-01-25 | the architecture role | Updated requirements summary after architecture |
-->
