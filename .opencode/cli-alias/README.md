...
> ⚡ **This is an alias for [@comfanion/workflow](https://www.npmjs.com/package/@comfanion/workflow)** - same package, easier to remember!

AI-assisted development workflow with **semantic code search**, agents, and structured documentation.

[![npm version](https://img.shields.io/npm/v/create-opencode-workflow.svg)](https://www.npmjs.com/package/create-opencode-workflow)
[![main package](https://img.shields.io/badge/main%20package-@comfanion/workflow-blue)](https://www.npmjs.com/package/@comfanion/workflow)
...
# Check index status
npx create-opencode-workflow index --status
```
...
npx create-opencode-workflow vectorizer status    # Check status
```
